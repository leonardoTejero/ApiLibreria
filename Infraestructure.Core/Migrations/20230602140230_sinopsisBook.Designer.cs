...
namespace Infraestructure.Core.Migrations
{
    ...
    [Migration("20230602140230_sinopsisBook")]
    partial class sinopsisBook
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infraestructure.Entity.Model.Library.AuthorBookEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Infraestructure.Entity.Model.Library.AuthorEntity", b =>
                {
                    b.Property<int>("IdAuthor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Infraestructure.Entity.Model.Library.BookEntity", b =>
                {
                    b.Property<int>("IdBook")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Infraestructure.Entity.Model.Library.EditorialEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Infraestructure.Entity.Model.Library.AuthorBookEntity", b =>
                {
                    b.HasOne("Infraestructure.Entity.Model.Library.AuthorEntity", "AuthorEntity")
                        .WithMany("AuthorBookEntities")
                        .HasForeignKey("IdAuthor")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Infraestructure.Entity.Model.Library.BookEntity", "BookEntity")
                        .WithMany("AuthorBookEntities")
            ...
            modelBuilder.Entity("Infraestructure.Entity.Model.Library.BookEntity", b =>
                {
                    b.HasOne("Infraestructure.Entity.Model.Library.EditorialEntity", "EditorialEntity")
